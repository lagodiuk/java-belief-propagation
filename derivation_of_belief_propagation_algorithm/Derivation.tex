...
Taking into account \Cref{eq:marginal_probabilities_one_node,eq:marginal_probabilities_two_nodes}: we can substitute summations of probability density functions -- to marginal probabilities:
\begin{equation}
\begin{split}
