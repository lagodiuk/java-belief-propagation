...
Lets use Lagrange multipliers method \cite{wikipedia_lagrange_multipliers} for this purpose. Lets construct lagrangian, according 
\begin{equation}
\begin{split}
...
\end{split}
\end{equation}
Where: $\gamma_i$, $\gamma_j$, $\gamma_{ij}$, $\lambda_{ji}(x_i)$ and $\lambda_{ij}(x_j)$ -- lagrange multipliers.

\begin{equation}
{\partial \mathcal{L} \over \partial b_i(x_i)} = 0
\end{equation}

\begin{equation}
{\partial \mathcal{L} \over \partial b_j(x_j)} = 0
\end{equation}

\begin{equation}
{\partial \mathcal{L} \over \partial b_{ij}(x_i,x_j)} = 0
\end{equation}
