...
Using Hammersley-Clifford Theorem\footnote{} -- we can follow up, that probability distribution of configurations of graph might be factorized into positive functions defined on cliques that cover all the nodes and edges (this also called a \emph{Gibbs distribution})\cite{hammersley_clifford_proof, wikipedia_hammersley_clifford}:
